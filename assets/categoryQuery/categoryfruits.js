...
const fetchFoodList = async () => {
  const endpoint = "/food/get?category_type=FRUITS"; // THOUGHTS: There should be an endpoint for featured products...
...
/* const app = document.getElementById("root11");
...
const url =
  "https://cors-anywhere.herokuapp.com/http://intriobasket.pexceptos.com/api/food/get?category_type=FRUITS";
