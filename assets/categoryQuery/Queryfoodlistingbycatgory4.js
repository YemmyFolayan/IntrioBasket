...
const fetchFoodList = async () => {
  const endpoint = "/food/get?category_type=MEAT%20AND%20FISH%2FFISH"; // THOUGHTS: There should be an endpoint for featured products...
...
const app = document.getElementById("root6");
