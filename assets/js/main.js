    ...
    //define productDetails
      ...
      const fetchFoodList = async () => {
        ...
        featuredProducts.forEach((product) => {
          ...
          $("body").prepend(
            `'<div id="quickview"> <div class="quickview-box"> <button class="round-icon-btn" id="quickview-close-btn"><i class="fas fa-times"></i></button> <div class="row"> <div class="col-12 col-md-6"> <div class="shop-detail_img"> <button class="round-icon-btn" id="zoom-btn"> <i class="icon_zoom-in_alt"></i></button> <div class="big-img big-img_qv"> <div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div></div><div class="slide-img slide-img_qv"> <div class="slide-img_block"></div><div class="slide-img_block"></div><div class="slide-img_block"></div><div class="slide-img_block"></div></div></div></div><div class="col-12 col-md-6"> <div class="shop-detail_info"> <h5 class="product-type color-type">${productDetails.type} </h5><a class="product-name" href="shop_detail.html">${productDetails.name}</a> <div class="price-rate"> <h3 class="product-price">NGN ${productDetails.price}</h3> </div><p class="product-describe"> ${productDetails.description}</p><div class="quantity-select"> <label for="quantity">Quantity:</label> <input class="no-round-input" id="quantity" type="number" min="0" value="1"> </div><div class="product-select"> <button class="add-to-cart normal-btn outline">Add to Cart</button> <button class="add-to-compare normal-btn outline">+ Add to Compare</button> </div><div class="product-share"> <h5>Share link:</h5><a href=""><i class="fab fa-facebook-f"> </i></a><a href=""><i class="fab fa-twitter"></i></a><a href=""><i class="fab fa-invision"> </i></a><a href=""><i class="fab fa-pinterest-p"></i></a> </div></div></div></div></div></div>'`
          );
