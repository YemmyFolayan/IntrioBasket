  ...
  $(document).ready(function () {
    ...
    $("header .department-menu").on("click", function (event) {
      ...
      $(this)
        .children("span")
        .children()
        .toggleClass("arrow_carrot-down arrow_carrot-up");
    });

    $("#mobile-menu #ogami-mobile-menu .sub-menu").slideUp();
    $("#mobile-menu #ogami-mobile-menu .sub-menu--expander").on(
      "click",
      function (event) {
    ...
    (function ($) {
      function mediaSize() {
        if (window.matchMedia("(min-width: 1200px)").matches) {
          ...
          $("header .department-menu_block.down .department-menu span i")
    ...
    function mainSlider() {
      ...
      BasicSlider.on("init", function (e, slick) {
        var $firstAnimatingElements = $(".slider-block:first-child").find(
          "[data-animation]"
        );
    ...
    $(
      ".home3-product-block .customer-satisfied .customer-satisfied_wrapper"
    ).slick({
      arrows: false,
      slidesToScroll: 1,
      dots: true,
    ...
    $list.on("click", function (event) {
      ...
      $(this).addClass("active");
      $(".shop-products_bottom .product")
        .removeClass("grid-view zoomIn")
        .addClass("list-view animated fadeInUp");
      $(".shop-products_bottom--fullwidth .product")
        .removeClass("grid-view zoomIn")
        .addClass("full-list-view animated fadeInUp");
      $(".shop-products_bottom .col-6.col-md-4")
        .removeClass("col-6 col-md-4")
        .addClass("col-12");
      $(".shop-products_bottom--fullwidth .col-6.col-md-4.col-xxl-3.col-xxxl")
        .removeClass("col-6 col-md-4 col-xxl-3 col-xxxl")
        .addClass("col-12");
    });
    ...
    $grid.on("click", function (event) {
      ...
      $(this).addClass("active");
      $(".shop-products_bottom .product")
        .removeClass("list-view fadeInUp")
        .addClass("grid-view animated zoomIn");
      $(".shop-products_bottom--fullwidth .product")
        .removeClass("full-list-view fadeInUp")
        .addClass("grid-view animated zoomIn");
      $(".shop-products_bottom .col-12")
        .removeClass("col-12")
        .addClass("col-6 col-md-4");
      $(".shop-products_bottom--fullwidth .col-12")
        .removeClass("col-12")
        .addClass("col-6 col-md-4 col-xxl-3 col-xxxl");
    });
    ...
    ****************************************************/
    ...
    $(document).on("click", ".quickview", function (event) {
      ...
      $("body").prepend(
        '<div id="quickview"> <div class="quickview-box"> <button class="round-icon-btn" id="quickview-close-btn"><i class="fas fa-times"></i></button> <div class="row"> <div class="col-12 col-md-6"> <div class="shop-detail_img"> <button class="round-icon-btn" id="zoom-btn"> <i class="icon_zoom-in_alt"></i></button> <div class="big-img big-img_qv"> <div class="big-img_block"><img src="+${productDetails.imageUrl}+" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="big-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div></div><div class="slide-img slide-img_qv"> <div class="slide-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="slide-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="slide-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div><div class="slide-img_block"><img src="${productDetails.imageUrl}" alt="product image"></div></div></div></div><div class="col-12 col-md-6"> <div class="shop-detail_info"> <h5 class="product-type color-type">${productDetails.type}</h5><a class="product-name" href="shop_detail.html">${productDetails.name}</a> <div class="price-rate"> <h3 class="product-price">`
        + ${productDetails.name} + `</h3> </div><p class="product-describe">` + ${productDetails.description} + `</p><div class="quantity-select"> <label for="quantity">Quatity:</label> <input class="no-round-input" id="quantity" type="number" min="0" value="1"> </div><div class="product-select"> <button class="add-to-cart normal-btn outline">Add to Cart</button> <button class="add-to-compare normal-btn outline">+ Add to Compare</button> </div><div class="product-share"> <h5>Share link:</h5><a href=""><i class="fab fa-facebook-f"> </i></a><a href=""><i class="fab fa-twitter"></i></a><a href=""><i class="fab fa-invision"> </i></a><a href=""><i class="fab fa-pinterest-p"></i></a> </div></div></div></div></div></div>'
      );
